...
public class FileRenameUtil {
	...
	public static void changeNameInOnePathFromTemplate(String filePath, String template) throws
	...
	public static List<FileNameObj> getFileNameObjsInOnePath(String filePath) throws RuntimeException {
	...
	/**
	 * @param fileNames - a List contains the FileNameObjs
	 ...
	 */
	public static void renameFilesUsingNum(List<FileNameObj> fileNames, String template, int startIndex,
	                                       boolean isRenamable) throws TemplateException, FileNotFoundException {
		FileNameObj fnObj;
		int fileIndex = startIndex;
		for (FileNameObj fileName : fileNames) {
			fnObj = fileName;
			fnObj.setNewFileName(ORI_FILE_TEMPLATE.getFileNameFromTemplate(fnObj.getFullOldFileName(), template));
