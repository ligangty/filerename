...
public class LocaleHelper {
	...
	private final transient ResourceBundle resourceBundleForCurrentUserLocale;
	...
	private LocaleHelper(String resourceBundleBaseName) {
		...
		this.resourceBundleForCurrentUserLocale = ResourceBundle.getBundle(resourceBundleBaseName, currentUserLocale);
	}
	...
	public static LocaleHelper getInstance(String resourceBundleBaseName, Locale specLocale) {
		currentUserLocale = specLocale;
	 ...
	 * given content key
	 */
	public final String getContentStringWithParameters(String contentKey, String[] contentStringParameters) {
		return MessageFormat.format(this.getLocaleString(contentKey), new Object[] { contentStringParameters });
	}
	...
	public String formatDate(java.util.Date aDate) {
		...
		SimpleDateFormat ibmDateFormat = new SimpleDateFormat(DATE_PATTERN, currentUserLocale);
